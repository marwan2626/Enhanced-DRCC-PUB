...
net, const_load_household, const_load_heatpump, time_steps, df_season_heatpump_prognosis, df_household, heatpump_scaling_factors_df = gd.setup_grid_irep(season)
Bbus = dt.calculate_bbus_matrix(net)
mc_samples = mc.generate_samples(df_season_heatpump_prognosis)


opf_results = opf.solve_opf(net, time_steps, const_load_heatpump, const_load_household, heatpump_scaling_factors_df, Bbus)
...
drcc_results = drcc.drcc_opf(net, time_steps, const_load_heatpump, const_load_household, Bbus, df_season_heatpump_prognosis, heatpump_scaling_factors_df, max_iter_drcc=100, alpha=0.05, eta=1e-4)
